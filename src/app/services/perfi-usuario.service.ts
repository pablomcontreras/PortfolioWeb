...
export class PerfilUsuarioService {
  ...
  public lista(): Observable<PerfilUsuario[]> {
    return  this.httpClient.get<PerfilUsuario[]>(this.baseURL + 'api/perfilusuario/', cabecera);

  }

  public detalle(id: number): Observable<PerfilUsuario> {
    return this.httpClient.get<PerfilUsuario>(this.baseURL + `api/perfilusuario/${id}`, cabecera);
  }
